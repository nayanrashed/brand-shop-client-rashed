...
const Offers = () => {
  return (
    <div className="my-6 ">
        <h2 className="text-center text-xl font-semibold">Our features</h2>
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6 shadow-lg shadow-lime-200">
        <div className="flex mx-auto w-64 h-24 rounded-lg bg-orange-700">
        ...
        <div className="flex mx-auto w-64 h-24 rounded-lg bg-sky-500">
        ...
        <div className="flex mx-auto  w-64 h-24 rounded-lg bg-yellow-500">
        ...
        <div className="flex mx-auto w-64 h-24 rounded-lg bg-slate-500">
